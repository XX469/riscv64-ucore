...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2110820  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
